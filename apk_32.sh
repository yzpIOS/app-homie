...
do
  flutter build apk --target-platform android-arm --obfuscate --split-debug-info=./gen/symbolize --dart-define-from-file=./env/release.json --android-project-arg armv7 --dart-define=channelCode=$element
done