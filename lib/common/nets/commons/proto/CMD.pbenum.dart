...
class CMD extends $pb.ProtobufEnum {
  ...
  static const CMD C_OnlineList = CMD._(2110, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'C_OnlineList');
  static const CMD S_OnlineList = CMD._(2111, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_OnlineList');
  ...
  static const CMD S_MoreGiftPlay = CMD._(3111, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_MoreGiftPlay');
  static const CMD S_MoreGiftFloatingScreen = CMD._(3112, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_MoreGiftFloatingScreen');
  ...
  static const CMD S_CameraSwitch = CMD._(12030, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_CameraSwitch');
  static const CMD C_PKInvite = CMD._(20001, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'C_PKInvite');
  static const CMD S_PKInvite = CMD._(20002, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKInvite');
  static const CMD C_PKAccept = CMD._(20003, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'C_PKAccept');
  static const CMD S_PKInviteResult = CMD._(20004, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKInviteResult');
  static const CMD C_PKRoomList = CMD._(20005, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'C_PKRoomList');
  static const CMD S_PKRoomList = CMD._(20006, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKRoomList');
  static const CMD C_PKSceneLoaded = CMD._(20010, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'C_PKSceneLoaded');
  static const CMD S_PKGameInfo = CMD._(20011, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKGameInfo');
  static const CMD S_PKUserEnter = CMD._(20012, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKUserEnter');
  static const CMD C_PKBattleReady = CMD._(20031, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'C_PKBattleReady');
  static const CMD S_PKSyncRoles = CMD._(20032, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKSyncRoles');
  static const CMD C_PKMove = CMD._(20034, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'C_PKMove');
  static const CMD C_PKStop = CMD._(20035, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'C_PKStop');
  static const CMD S_PKSyncRoleAttsLF = CMD._(20036, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKSyncRoleAttsLF');
  static const CMD S_PKSyncRoleAttsHF = CMD._(20037, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKSyncRoleAttsHF');
  static const CMD S_PKSceneToxic = CMD._(20038, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKSceneToxic');
  static const CMD S_PKSceneGift = CMD._(20039, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKSceneGift');
  static const CMD S_PKBattleEnd = CMD._(20050, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKBattleEnd');
  static const CMD C_PKContinue = CMD._(20051, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'C_PKContinue');
  static const CMD S_PKContinue = CMD._(20052, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'S_PKContinue');
