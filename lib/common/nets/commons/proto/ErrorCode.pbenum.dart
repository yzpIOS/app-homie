...
class ErrorCode extends $pb.ProtobufEnum {
  ...
  static const ErrorCode NETWORK_ANOMALY = ErrorCode._(16, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NETWORK_ANOMALY');
  static const ErrorCode Success = ErrorCode._(200, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'Success');
  ...
  static const ErrorCode USE_COUNT_MORE_THAN_BACKPACK = ErrorCode._(10010, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'USE_COUNT_MORE_THAN_BACKPACK');
  ...
  static const ErrorCode USE_COUNT_MORE_THAN_OWNS_COUNT = ErrorCode._(14005, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'USE_COUNT_MORE_THAN_OWNS_COUNT');
  static const ErrorCode BLIND_BOX_LOTTERY_FAIL = ErrorCode._(14006, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BLIND_BOX_LOTTERY_FAIL');
  ...
  static const ErrorCode ROOM_MESSAGE_NOT_EXIST = ErrorCode._(16015, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOM_MESSAGE_NOT_EXIST');
  static const ErrorCode ROOM_UID_UP_ING = ErrorCode._(16016, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOM_UID_UP_ING');
  static const ErrorCode ROOM_LIVE_STOP = ErrorCode._(16017, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOM_LIVE_STOP');
  static const ErrorCode ROOM_UNABLE_BLACK = ErrorCode._(16018, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOM_UNABLE_BLACK');
  static const ErrorCode ROOM_BAN_CHAT = ErrorCode._(16019, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOM_BAN_CHAT');
  static const ErrorCode ROOM_NOT_STOP_PERMISSION = ErrorCode._(16020, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOM_NOT_STOP_PERMISSION');
  static const ErrorCode ROOM_INIT_FAIL = ErrorCode._(16021, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOM_INIT_FAIL');
  ...
  static const ErrorCode ROOM_NOT_BELONG_GUILD_TYPE = ErrorCode._(16205, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOM_NOT_BELONG_GUILD_TYPE');
  ...
  static const ErrorCode GUILD_ANCHOR_IS_EXIST = ErrorCode._(16304, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GUILD_ANCHOR_IS_EXIST');
  static const ErrorCode GUILD_ANCHOR_NOT_EXIST = ErrorCode._(16305, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GUILD_ANCHOR_NOT_EXIST');
  static const ErrorCode GUILD_LEDGER_RATIO_FAILED = ErrorCode._(16306, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GUILD_LEDGER_RATIO_FAILED');
  static const ErrorCode PK_ROOM_NOT_FOUND = ErrorCode._(16500, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PK_ROOM_NOT_FOUND');
  static const ErrorCode PK_ROOM_INVITE_EXIST = ErrorCode._(16501, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PK_ROOM_INVITE_EXIST');
  static const ErrorCode PK_ROOM_EXECUTING = ErrorCode._(16502, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PK_ROOM_EXECUTING');
  static const ErrorCode PK_ROOM_INVITING = ErrorCode._(16503, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PK_ROOM_INVITING');
  static const ErrorCode PK_ROOM_INVITE_EXPIRE = ErrorCode._(16504, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PK_ROOM_INVITE_EXPIRE');
  static const ErrorCode PK_ROOM_USER_NOT_ALLOWED_BATTLE_SWITCH = ErrorCode._(16505, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PK_ROOM_USER_NOT_ALLOWED_BATTLE_SWITCH');
  static const ErrorCode PK_ROOM_NOT_COMBATANT = ErrorCode._(16506, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PK_ROOM_NOT_COMBATANT');
  static const ErrorCode PK_ROOM_FINISH = ErrorCode._(16507, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PK_ROOM_FINISH');
  ...
  static const ErrorCode WITHDRAW_CASH_IS_TOO_SMALL = ErrorCode._(20012, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WITHDRAW_CASH_IS_TOO_SMALL');
  ...
  static const ErrorCode RANDOM_BUFF_GIFT_IS_EMPTY = ErrorCode._(26001, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RANDOM_BUFF_GIFT_IS_EMPTY');
