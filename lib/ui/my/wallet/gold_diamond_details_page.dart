...
class GoldDiamondDetailsPage extends StatefulWidget {
  const GoldDiamondDetailsPage({super.key});

  @override
  State<GoldDiamondDetailsPage> createState() => _DetailsListViewState();
}

class _DetailsListViewState extends SimplePageState<Map, GoldDiamondDetailsPage> {
  ...
  @override
  void didUpdateWidget(covariant GoldDiamondDetailsPage oldWidget) {
  ...
  Future fetchPage(PageNum page) async {
    var result = await Api.Finance.goldDetail(type: type, page: page);
