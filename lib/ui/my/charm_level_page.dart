...
/// 魅力等级
/// 
class CharmLevelPage extends StatefulWidget {
  final UID uid;

  const CharmLevelPage({super.key, required this.uid});

  @override
  State<CharmLevelPage> createState() => _LevelPageState();
}

class _LevelPageState extends State<CharmLevelPage> {
    ...
    Widget child = Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const Text('在直播间收礼等一切直播间内的收礼，都可以提升用户等级。累计收礼越多，对应的等级越高'),
        ],
      ),
    );
