...
/// 个播：下麦二次确认
///
class DownMicConfirmDialog extends StatefulWidget {
  ...
  static void show() {
    showDialog(context: Get.context!, builder: (context) {
      return DownMicConfirmDialog();
    });
  }
}

class _DownMicConfirmState extends State<DownMicConfirmDialog> {
