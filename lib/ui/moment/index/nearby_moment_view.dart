...
//
// class NearbyMomentView extends StatelessWidget {
//   const NearbyMomentView({Key? key}) : super(key: key);
//
//   @override
//   Widget build(BuildContext context) {
//     // Widget header = _NearbyView();
//
//     // header = Material(
//     //   color: Colors.white,
...
//           ),
//           child: MomentView(api: (page) => Api.Moment.nearbyList(page: page)),
//         ),
//       ],
//     );
//   }
// }
//
// // class _NearbyView extends SimpleDataView<Map> {
// //   @override
// //   Future fetch() {
